...
func TestConvertToVolumesWithDriverSubfield(t *testing.T) {
	libcomposeVolumeConfigs := map[string]*config.VolumeConfig{
		namedVolume: &config.VolumeConfig{
			Driver: "noodles",
		},
...
func TestConvertToVolumesWithDriverOptsSubfield(t *testing.T) {
...
func TestConvertToVolumesWithExternalSubfield(t *testing.T) {
	...
	assert.NoError(t, err, "Unexpected error converting libcompose volume configs when external is specified")
}
